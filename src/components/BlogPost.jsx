  ...
  return (
    <article className="blog-post">
      ...
      <motion.div 
        ...
        className="flex flex-wrap items-center gap-3 text-sm text-gray-500 dark:text-gray-400 mb-8 pb-6 border-b border-gray-200 dark:border-gray-700"
      >
        ...
        <span className="text-gray-300">|</span>
        <span>Source: Saasfactor.co</span>
      </motion.div>
